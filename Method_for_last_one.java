...
public class Method_for_last_one {
    boolean is_main_city_exists = false;
    ...
    public Method_for_last_one(GRAPH gr){
        graphis = gr;
        d = new int[gr.getSizeOfVertixes()];
    }

    public String how_less_amount_of_cities(String name_city_main, String name_city_edge1, String name_city_edge2, int length){
